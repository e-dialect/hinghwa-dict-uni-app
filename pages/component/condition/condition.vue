<template>
    <view>
        ...
        <view class="cu-form-group">
            ...
            <picker mode="multiSelector" @change="MultiChange" @columnchange="MultiColumnChange" :value="multiIndex" :range="yunmu">
                <view class="picker">
        ...
        <view class="padding bg-white solid-bottom" v-for="(item, index) in result" :key="index">
            ...
            <view>
                <text :data-id="item.word" @tap="getWord" v-for="(item, index1) in item.characters" :key="index1">
                    ...
                    <text v-if="item.traditional !== item.character" class="text-xl" space="emsp">{{ item.traditional }}</text>
