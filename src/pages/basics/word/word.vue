<template>
    <view>
        <scroll-view scroll-y class="scrollPage">
            <image src="/static/images/word.png" mode="aspectFill" style="width: 100%"></image>
            <view class="text-xl text-white back" @tap="back">
            ...
            <view class="layout-index" style="z-index: 100">
                <view class="flex card padding-sm">
                    <view class="flex-sub text-center text-bold text-slp margin-right-sm" style="border: 1px solid grey">{{ word.word }}</view>
                    <view class="flex-twice flex flex-direction justify-center">
                        ...
                        <view class="margin-top-sm text-grey">
                            来源：
                            <text class="text-blue" @tap="toVisitor">{{ word.contributor.username }}</text>
                        </view>
                    </view>
                </view>
                ...
                <view class="flex">
                    <view class="flex-sub card-other padding">
                        ...
                        <view class="flex justify-between margin-top-sm" @tap="getMore" :data-id="index" v-for="(item, index) in related_words" :key="index">
                    ...
                    <view class="flex-sub card-pth padding">
                        ...
                        <text class="text-df text-grey margin-top-sm" v-for="(item, index) in word.mandarin" :key="index">{{ item }}</text>
                    </view>
                </view>
                <view class="card padding-sm">
                    ...
                    <view class="article" v-for="(item, index) in related_articles" :key="index">
