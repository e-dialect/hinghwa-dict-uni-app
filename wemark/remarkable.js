            ...
            3: [
                function (e, t, r) {
                    ...
                    var s = /[a-zA-Z_:][a-zA-Z0-9:._-]*/,
                        ...
                        d = /<![A-Z]+\s+[^>]*>/,
                        g = /<!\[CDATA\[([^\]]+|\][^\]]|\]\][^>])*\]\]>/,
                        m = n(/^(?:open_tag|close_tag|comment|processing|declaration|cdata)/)('open_tag', u)('close_tag', p)('comment', h)('processing', f)('declaration', d)(
                            'cdata',
                            g
                        )();
            ...
            5: [
                function (e, t, r) {
                    ...
                    function u(e, t) {
                        ...
                        return o(v, t)
                            ? v[t]
                            : 35 === t.charCodeAt(0) && b.test(t) && ((r = 'x' === t[1].toLowerCase() ? parseInt(t.slice(2), 16) : parseInt(t.slice(1), 10)), a(r))
                            ? c(r)
                            : e;
                    }
                ...
                function (e, t, r) {
                    ...
                    function n(e, t) {
                        ...
                        return (
                            ...
                            (s = e.eMarks[t]),
                            n >= s ? -1 : ((r = e.src.charCodeAt(n++)), 42 !== r && 45 !== r && 43 !== r ? -1 : s > n && 32 !== e.src.charCodeAt(n) ? -1 : n)
                        );
                    }
                ...
                function (e, t, r) {
                    ...
                    function n(e, t, r, n) {
                        ...
                        return (
                            ...
                            0 === p.length ? -1 : (n.abbreviations || (n.abbreviations = {}), 'undefined' == typeof n.abbreviations[':' + u] && (n.abbreviations[':' + u] = p), a)
                        );
                    }
                        ...
                        if (h > p + 1)
                            if (((r = e.src.charCodeAt(p + 1)), 35 === r)) {
                                if ((u = e.src.slice(p).match(l)))
                                    return (
                                        t || ((c = 'x' === u[1][0].toLowerCase() ? parseInt(u[1].slice(1), 16) : parseInt(u[1], 10)), (e.pending += i(o(c) ? c : 65533))),
                                        (e.pos += u[0].length),
                                        !0
                                    );
                ...
                function (e, t, r) {
                    ...
                    t.exports = function (e, t) {
                        ...
                        if (((p = l + 1), m > p && 40 === e.src.charCodeAt(p))) {
                            ...
                            if (m > p && b !== p && o(e, p)) for (u = e.linkContent, p = e.pos; m > p && ((f = e.src.charCodeAt(p)), 32 === f || 10 === f); p++);
                            else u = '';
                            ...
                            if (
                                (m > p && 91 === e.src.charCodeAt(p) && ((b = p + 1), (p = n(e, p)), p >= 0 ? (a = e.src.slice(b, p++)) : (p = b - 1)),
                        ...
                        return (
                            ...
                            (e.HtmlTag = e.Util.extend(Object, {
                                ...
                                removeClass: function (t) {
                                    for (
                                        var r, n = this.getClass(), s = this.whitespaceRegex, o = e.Util.indexOf, i = n ? n.split(s) : [], l = t.split(s);
                                        i.length && (r = l.shift());
